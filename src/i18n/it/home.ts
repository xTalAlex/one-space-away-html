export const home = {
    ...
    projects: [
      {
        ...
        result: {
          title: "Risultato",
          text: "La nostra casa ora sembra molto più aperta e ariosa. La trasformazione ha ampliato la zona giorno, facendo sembrare ogni stanza più grande e luminosa. Con un design che privilegia la luce naturale, la nostra casa è ora perfettamente configurata per la vita di tutti i giorni e i momenti in famiglia.",
        },
      },
      {
        images: {
        ...
        result: {
          title: "Risultato",
          text: "Ora, la nostra cucina sembra completamente rinnovata. L'illuminazione migliorata rende lo spazio più luminoso e accogliente, mentre i nuovi elementi in stile legno si adattano perfettamente alla nostra visione.",
        },
      },
    ],
  },
  ...
  process: {
    tag: "COME FUNZIONA",
    title: "Come diamo vita al tuo spazio.",
    steps: [
      {
        title: "Connettiti",
    ...
    items: [
      {
        ...
        text: "In One Space Away, crediamo che il grande design non riguardi solo l'estetica, ma la creazione di spazi che ti facciano sentire a casa. Ecco perché ci prendiamo il tempo per comprendere la tua visione, il tuo stile di vita e le tue esigenze, assicurandoci che ogni dettaglio sia su misura per te.",
      },
      {
        title: "La Nostra Visione",
        text: "Con questa profonda comprensione, trasformiamo le idee in interni progettati con cura. Dai materiali selezionati con cura ai layout personalizzati, ci concentriamo su ogni dettaglio per rendere la tua casa unicamente tua.",
      },
    ],
  },
  faq: {
    tag: "FAQ",
    title: "Abbiamo le risposte.",
    items: [
      {
  ...
  contact: {
    tag: "CONTATTACI",
    title: "Creiamo uno spazio che sia veramente tuo.",
    hello: "Dicci ciao",
    location: "Posizione",
    form: {
      name: "Nome",
